...
@class KAProgressLabelVF;
typedef void(^KAlabelValueChangedCompletion)(KAProgressLabelVF *label);
typedef void(^KAlabelValueChangedCompletion)(KAProgressLabelVF *label);



IB_DESIGNABLE
@interface KAProgressLabelVF : UILabel

@property (nonatomic, copy) KAlabelValueChangedCompletion labelVCBlock;
@property (nonatomic, copy) KAlabelValueChangedCompletion labelAnimCompleteBlock;
