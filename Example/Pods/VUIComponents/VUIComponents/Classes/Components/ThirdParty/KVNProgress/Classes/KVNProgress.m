...
@property (nonatomic, weak) IBOutlet NSLayoutConstraint *statusLabelTopToSuperViewConstraint;
...
- (void)setupConstraints
{
	...
	self.circleProgressViewBottomToSuperViewConstraint.constant = statusInset;
	self.statusLabelTopToSuperViewConstraint.constant = statusInset;
...
- (void)setupInfiniteCircle
{
	...
	UIBezierPath *circlePath = [UIBezierPath bezierPathWithArcCenter:center
														  ...
														  startAngle:GLKMathDegreesToRadians(50.0f)
...
- (void)updateBackgroundConstraints
{
	if (![self isFullScreen] && self.status.length == 0) {
		...
		self.statusLabelTopToSuperViewConstraint.constant = KVNContentViewWithoutStatusInset;
