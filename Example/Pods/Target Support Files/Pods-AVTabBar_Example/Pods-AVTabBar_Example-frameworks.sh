...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VFAuthKeyCloak/VFAuthKeyCloak.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VFEG-NetworkManager/VFEG_NetworkManager.framework"
